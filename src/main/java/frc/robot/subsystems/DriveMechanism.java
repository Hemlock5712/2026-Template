...
public class DriveMechanism extends Mechanism {
  // The logged wrapper, not the drivetrain itself: same methods, but every read comes from the log
  // during replay and every write is skipped. Nothing else here has to know which mode we are in.
  ...
  private final LoggedSwerveDrivetrain drivetrain =
      new LoggedSwerveDrivetrain(TunerConstants.createDrivetrain());
